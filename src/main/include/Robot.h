...
class Robot : public frc::TimedRobot {
 public:
  ...
  rev::SparkMaxPIDController neoPID = neo->GetPIDController();
  rev::SparkMaxRelativeEncoder neoEncoder = neo->GetEncoder();   
  ...
  rev::CANSparkMax* c_lMotor = new rev::CANSparkMax(18, rev::CANSparkMax::MotorType::kBrushless);
  rev::CANSparkMax* c_rMotor = new rev::CANSparkMax(17, rev::CANSparkMax::MotorType::kBrushless);
